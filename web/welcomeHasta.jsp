...
<div class="form-group" >
  ...
  <button style="background:#f44336; border: 2px solid #f44336"> <a href="ilacGoruntule.jsp?TCNO=<%=hasta.getTcNumber()%>">İlaçlarımı Göster</a></button>
  <br><br>
   <button style="background: #f44336;border: 2px solid #f44336">  <a href="hastaBilgileri.jsp?TCNO=<%=hasta.getTcNumber()%>">Bilgilerim</a> </button><br><br>
  <button style="background: #f44336;border: 2px solid #f44336"> <a href="hastaCikisServlet">Çıkış Yap</a></button>
